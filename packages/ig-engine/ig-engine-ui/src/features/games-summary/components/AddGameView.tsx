  ...
  return (
    ...
    >
      <View style={{ maxWidth: 200, marginEnd: 8 }} >
        <RnuiTextInput testID="game-code-input" label="Invitation code" value={gameCode} onChangeText={setGameCode}/>
      </View>
      <RnuiButton testID="add-game-button" onPress={handlePress} disabled={gameCode === ""}>Join Game</RnuiButton>
    </View>
  );
};
