...
import type { GameConfigLogicAdapter, GameConfigsTableAdapter } from '@ig/games-be-models';
import type { GameConfigIdT, GameConfigT, UpdateGameConfigInputT, UpdateGameConfigResultT } from '@ig/games-models';
